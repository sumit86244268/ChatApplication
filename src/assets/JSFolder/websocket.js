...
export const connectWebSocket = (username) => {
    ...
    // const socket = new SockJS(`https://chatapplication-f34s.onrender.com/ws-chat?username=${username}`);
    ...
    stompClient = new Client({
        webSocketFactory: () => new SockJS(`https://chatapplication-f34s.onrender.com/ws-chat?username=${username}`),
        reconnectDelay: 5000
    });
