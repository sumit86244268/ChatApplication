...
function Login({ setUser, setUserDetails }) {
    ...
    const handleFileChange = async (e) => {
        ...
        const res = await axios.post(`https://chatapplication-f34s.onrender.com/api/file/upload`, data);
        if (res.data) {
    ...
    const submitSignInData = async (e) => {
        e.preventDefault();
        try {
            const result = await axios.post("https://chatapplication-f34s.onrender.com/api/user/login", loginform);
    ...
    const submitSignUpData = async (e) => {
        ...
        try {
            ...
            const result = await axios.post("https://chatapplication-f34s.onrender.com/api/user/signup", form);
